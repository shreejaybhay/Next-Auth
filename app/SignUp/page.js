                    ...
                    <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form onSubmit={submitHandler} class="space-y-4 md:space-y-6">
                            <div>
                                ...
                                <input value={user.username} onChange={(e) => setUser({ ...user, username: e.target.value })} type="Username" name="Username" id="Username" placeholder="Username" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required="" />
                            </div>
                            <div>
                            ...
                            <button type="submit" class={`${disable ? "bg-[#111827] cursor-not-allowed" : "bg-[#2563EB]"} w-full text-white  hover:bg-primary-700 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700`}>Create an account</button>
                            <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                                Already have an account? <a href="login" class="font-medium text-primary-600 hover:underline dark:text-[#2A77F6]">Login here</a>
                            </p>
                        </form>
                    </div>
                </div>
